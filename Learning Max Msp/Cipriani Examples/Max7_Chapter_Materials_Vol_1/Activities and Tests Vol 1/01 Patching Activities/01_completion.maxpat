...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.0, 483.0, 56.0, 22.0 ],
					"sig" : 0.0,
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 22.12793, 49.195129, 382.334229, 366.673218 ],
					"range" : [ 0.125, 70.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.462158, 17.146332, 285.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 420.0, 50.0, 22.0 ],
					"style" : "default",
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 70.0, 464.0, 60.0, 22.0 ],
					"style" : "default",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 488.0, 43.0, 22.0 ],
					"style" : "default",
					"text" : "loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 668.0, 33.0, 22.0 ],
					"style" : "default",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 633.0, 74.0, 22.0 ],
					"style" : "default",
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 142.0, 677.0, 37.0, 22.0 ],
					"style" : "default",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 143.0, 557.0, 19.0, 111.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 223.0, 446.0, 169.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 142.0, 517.0, 90.0, 22.0 ],
