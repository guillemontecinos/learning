...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 20.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 90.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "set shepenv"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 201.0, 134.0, 200.0, 112.0 ],
...
,
					"patching_rect" : [ 433.0, 22.0, 71.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 47.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 155.0, 78.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 216.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "s phase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 75.0, 68.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 412.0, 122.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 412.0, 185.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 190.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "r to_out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 320.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.5, 285.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 320.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 512.0, 214.0, 19.0, 84.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 256.0, 303.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 63.0, 209.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 63.0, 286.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "peek~ shepenv"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 132.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "uzi 512 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 23.0, 16.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 134.0, 100.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 96.0, 167.0, 97.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ shepenv"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 75.0, 113.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 92.0, 75.0, 20.0 ],
					"style" : "",
					"text" : "ENVELOPE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 491.0, 156.0, 95.0, 20.0 ],
					"style" : "",
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 342.5, 44.0, 421.5, 44.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 59.5, 74.0, 210.5, 74.0 ],
					"source" : [ "obj-5", 2 ]
				}
